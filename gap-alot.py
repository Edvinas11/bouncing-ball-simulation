...
mini_ball = MiniBall((255, 0, 0), (WIDTH / 2 - 10, HEIGHT / 2 - 90), radius=15, velocity=[-2, -2])
...
start_angle2 = 0.5 + 3.7 + 3
end_angle2 = 2 * math.pi + 3.7 + 3

start_angle3 = 0.5 + 6
end_angle3 = 2 * math.pi + 6

start_angle4 = 0.5 + 3
end_angle4 = 2 * math.pi + 3
...
while True:
    ...
    if running:
        ...
        # Status text
        drawText(f"Size: {round(mini_ball.radius, 2)}", font, (255, 255, 255), screen, WIDTH / 2, 45, 26, 1000)
